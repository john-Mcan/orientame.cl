...
fraseCotidiana: 'Me cuesta salir de la cama'
temasRelacionados:
  - depresion
  - estres-cronico
  - duelo
...
afirmacionesTrazables:
  - texto: 'Entre las características prominentes de los trastornos depresivos, la guía chilena incluye los cambios en el procesamiento psicomotor —retraso o agitación— junto a la pérdida de energía y los cambios en el sueño.'
    fuenteIds:
      - minsal-gpc-depresion
  - texto: 'La guía chilena recomienda la terapia de activación conductual, junto con la terapia cognitivo conductual, la interpersonal y la sistémica familiar, para el tratamiento de la depresión en personas adultas.'
    fuenteIds:
      - minsal-gpc-depresion
      - oms-depresion
---
...
- Si al despertar aparece una sensación de angustia intensa o la idea de que sería mejor no despertar. Si estás en una situación de sufrimiento extremo, recuerda que en [ayuda inmediata](/urgencia) hay orientación telefónica disponible las 24 horas.
